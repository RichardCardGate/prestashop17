 ...
 *   $this->l('Pay with')
 */
class Cardgatecreditcard extends CardgatePayment
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('CardGate Creditcard');
        $this->description = $this->l('Accepts payments with CardGate Creditcard.');
