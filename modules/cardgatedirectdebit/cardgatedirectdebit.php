 ...
 *   $this->l('Pay with')
 */
class Cardgatedirectdebit extends CardgatePayment
{
    ...
    public function __construct()
    {
        ...
        $this->name = 'cardgatedirectdebit';
        $this->paymentcode = 'directdebit';
        $this->ps_versions_compliancy = ['min' => '1.7', 'max' => _PS_VERSION_];
        $this->paymentname = 'DirectDebit';
        $this->logoname = 'directdebit';
        ...
        $this->displayName = $this->l('CardGate DirectDebit');
        $this->description = $this->l('Accepts payments with CardGate DirectDebit.');
