 ...
 *   $this->l('Pay with')
 */
class Cardgatepaypal extends CardgatePayment
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('CardGate PayPal');
        $this->description = $this->l('Accepts payments with CardGate PayPal.');
