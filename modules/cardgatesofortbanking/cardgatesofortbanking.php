 ...
 * $this->l('Pay with')
 */
class Cardgatesofortbanking extends CardgatePayment
{
    ...
    public function __construct()
    {
        ...
        $this->name = 'cardgatesofortbanking';
        $this->paymentcode = 'sofortbanking';
        $this->ps_versions_compliancy = ['min' => '1.7', 'max' => _PS_VERSION_];
        $this->paymentname = 'SOFORT Banking';
        $this->logoname = 'sofortbanking';
        ...
        $this->displayName = $this->l('CardGate SOFORT Banking');
        $this->description = $this->l('Accepts payments with CardGate SOFORT Banking.');
